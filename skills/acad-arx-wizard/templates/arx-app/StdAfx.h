...
// ARX SDK 2027 debug props enable /RTCc which the VS 2022+ STL rejects without this guard.
...
#pragma warning(disable : 4786 4996)
    ...
    [!if STD_COM_SERVER || ATL_COM_SERVER || MFC_EXT_SHARED || MFC_REG_SHARED]
//-----------------------------------------------------------------------------
#define STRICT
...
#define _ATL_ALL_WARNINGS
    ...
    [!if STD_COM_SERVER && !MFC_EXT_SHARED && !MFC_REG_SHARED]
//-----------------------------------------------------------------------------
...
#include <windows.h>
    ...
    [!endif]
//- ObjectARX and OMF headers needs this. <vector>/<string> required because
//- arxHeaders.h -> acuiComboBox.h uses std::vector without including <vector>.
#include <map>
#include <vector>
#include <string>

    [!if MFC_EXT_SHARED || MFC_REG_SHARED]
//-----------------------------------------------------------------------------
#include <winsock2.h>  //- Must precede windows.h (pulled in by afxwin.h)
#include <afxwin.h> //- MFC core and standard components
#include <afxext.h> //- MFC extensions
#include <afxcmn.h> //- MFC support for Windows Common Controls
#include <afxdlgs.h> //- MFC standard dialogs (CFileDialog, CColorDialog, etc.)
