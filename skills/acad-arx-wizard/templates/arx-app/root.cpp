...
//-----------------------------------------------------------------------------
//- DLL Entry Point
//- NOTE: When MFC_REG_SHARED is set (non-ext shared MFC), mfcs140u.lib already
//- contributes DllMain via dllmodul.obj. Defining one here causes LNK2005.
//- _hdllInstance is set by the ARX runtime, so we don't need our own DllMain
//- in plain MFC shared mode.
[!if !MFC_REG_SHARED || MFC_EXT_SHARED]
[!if DOTNET_MODULE]
